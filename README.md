...
Frontend (React): User menginput spesifikasi barang.

API (FastAPI): Menerima data input dan memprosesnya.

Model AI (.pkl): Melakukan kalkulasi prediksi berdasarkan pola data historis.

Result: Harga prediksi dikirim kembali ke user.
